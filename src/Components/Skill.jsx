    ...
    <div className="container mx-auto" id="skills">
      ...
      <div className="mx-2 flex flex-wrap justify-center gap-8 lg:gap-16 rounded-3xl px-4 py-2 lg:px-20 border border-stone-400">
        {SKILLS.map((skill, index) => (
          ...
          >
            <motion.div
              className="w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 flex items-center justify-center transition-all duration-300 hover:scale-110 hover:text-white hover:hover:bg-stone-200 hover:drop-shadow-2xl hover:transition-all hover:duration-500"
              whileHover={{
                scale: 1.2,
                rotate: 15,
